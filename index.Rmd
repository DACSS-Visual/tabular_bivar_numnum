...
Palettes can be selected from the [brewer colors website](http://colorbrewer2.org). Using the same palette as before, we can try a different plot (stat_density_2d):
...
```{r}
scatp3 = scatp3 + geom_text_repel(aes(label=County),color='yellow',facetype='bold') + 
...
scatp3 + labs(title = titleText,
    ...
    annotate("segment", x = 100, y = 100000, xend = 600, yend = 150000, 
         size = 4, linejoin = "mitre",
         arrow = arrow(type = "closed", length = unit(0.001, "cm"))) +
